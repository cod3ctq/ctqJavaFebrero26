...
public class Main {
    public static void main(String[] args) {
      ...
      //  cb.consultarSaldo("4532123456789020");
        ...
        pc.setDireccion("7 de mayo");
        pc.consultarSaldo("4532123456789020");

        //Prueba del metodo retirar

        Object[] x = cb.retirar("4532123456789020",1000,"4567");
...
//        System.out.println(x2[1]);//ticket
        ...
        cb.consultarSaldo("4532123456789016");//el saldo deberia ser 34000.90
