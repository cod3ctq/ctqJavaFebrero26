...
public class Main {
    public static void main(String[] args) {
        ...
        cb.setDireccion("AVvenida puebla");
        cb.setId(1040);
        //Cargar la lista de cuentas
        cb.setDatebase(cuentas);

        //cb.consultarSaldo("236338723983298329");

        Practicaja pc= new Practicaja();
        pc.setDatebase(cuentas);
        //pc.consultarSaldo("236338723983298329");

        //Prueba del metodo reirar.

//        Object[] x = cb.retirar("4532123456789020",10000,"4567");
//        System.out.println(x[0]);//Monto
//        System.out.println(x[1]);//Ticket

//        Object[] x2 = cb.retirar("4532123456789018",10000,"3456");
...
//        cb.consultarSaldo("4532123456789020");
        ...
        Object[] x3= pc.depositar( "4532123456789016", 4500);
