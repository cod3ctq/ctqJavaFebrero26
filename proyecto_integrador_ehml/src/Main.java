...
public class Main {
    public static void main(String[] args){
        ...
        cb.setDireccion("Avenida juarez #1258");
        cb.setId(1040);
        //cb.setFolio(0);

        //cargar la lista de ceuntas
        cb.setDataBase(cuentas);

        //cb.consultarSaldo("8764532123456789016");

        PractiCaja pc=new PractiCaja();
        pc.setDataBase(cuentas);
        pc.setDireccion("Boulevard 2 sur #231");
        //pc.consultarSaldo("4532123456789016");

        //PRUEBA DEL METODO RETIRAR
        Object[] x = cb.retirar("4532123456789020",10000, "1234");
        System.out.println(x[0]);
        System.out.println(x[1]);

        Object[] x2 = cb.retirar("4532123456789020",10000, "1234");
        System.out.println(x2[0]);
        System.out.println(x2[1]);

        cb.consultarSaldo("4532123456789020");

        Object[] x3 = pc.deposito("4532123456789016",5000);
        System.out.println(x3[1]);
        cb.consultarSaldo("4532123456789016");
    }
}
